//! String and number coercion helpers. Port of upstream `input/shared.rs`.
...
pub fn str_as_bool(input: &(impl Input + ?Sized), str: &str) -> ValResult<bool> {
    if str == "0"
...
pub fn int_as_bool(input: &(impl Input + ?Sized), int: i64) -> ValResult<bool> {
    if int == 0 {
        Ok(false)
    } else if int == 1 {
        Ok(true)
...
pub fn str_as_int(input: &(impl Input + ?Sized), str: &str) -> ValResult<EitherInt> {
...
pub fn str_as_float(input: &(impl Input + ?Sized), str: &str) -> ValResult<EitherFloat> {
...
pub fn float_as_int(input: &(impl Input + ?Sized), float: f64) -> ValResult<EitherInt> {
