...
serializers! {
    ...
    super::type_serializers::datetime_etc::DateSerializer,
    super::type_serializers::datetime_etc::DatetimeSerializer,
    super::type_serializers::datetime_etc::TimeSerializer,
    super::type_serializers::decimal::DecimalSerializer,
...
pub enum CombinedSerializer {
    ...
    FrozenSet(super::type_serializers::set::FrozenSetSerializer),
