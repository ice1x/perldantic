...
# pydantic-core's validator and serializer tests against the matching pydantic-core release.
#
...
for run in a b; do
    ...
    PYTHONHASHSEED=0 PYTHONDONTWRITEBYTECODE=1 PYTHONPATH="$ROOT/tools" "$VENV/bin/python" -m pytest tests/validators tests/serializers \
